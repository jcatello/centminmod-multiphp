...
packages='php73 php73-php-fpm php73-php-devel php73-php-embedded php73-php-mysqlnd php73-php-bcmath php73-php-enchant php73-php-gd php73-php-pecl-geoip php73-php-gmp php73-php-pecl-igbinary php73-php-pecl-igbinary-devel php73-php-pecl-imagick php73-php-pecl-imagick-devel php73-php-imap php73-php-intl php73-php-pecl-json-post php73-php-ldap php73-php-pecl-mailparse php73-php-mbstring php73-php-mcrypt php73-d php73-php-pspell php73-php-pecl-redis5 php73-php-snmp php73-php-soap php73-php-tidy php73-php-xml php73-php-xmlrpc php73-php-pecl-zip php73-php-opcache php73-php-sodium'
...
phpinstall() {
  ...
  sed "s|fastcgi_param  SERVER_NAME        \$server_name;|fastcgi_param  SERVER_NAME        \$http_host;|" /usr/local/nginx/conf/php.conf > /usr/local/nginx/conf/php73-remi.conf
