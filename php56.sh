...
packages='php56 php56-php-fpm php56-php-devel php56-php-embedded php56-php-mysqlnd php56-php-bcmath php56-php-enchant php56-php-gd php56-php-pecl-geoip php56-php-gmp php56-php-pecl-igbinary php56-php-pecl-igbinary-devel php56-php-pecl-imagick php56-php-pecl-imagick-devel php56-php-imap php56-php-intl php56-php-ldap php56-php-pecl-mailparse php56-php-mbstring php56-php-mcrypt php56-d php56-php-pspell php56-php-pecl-redis4 php56-php-snmp php56-php-soap php56-php-tidy php56-php-xml php56-php-xmlrpc php56-php-pecl-zip php56-php-opcache php56-php-brotli.x86_64 php56-php-zstd-devel php56-php-process'
