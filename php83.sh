...
packages='php83 php83-php-fpm php83-php-devel php83-php-embedded php83-php-mysqlnd php83-php-bcmath php83-php-enchant php83-php-gd php83-php-pecl-geoip php83-php-gmp php83-php-pecl-igbinary php83-php-pecl-igbinary-devel php83-php-pecl-imagick-im6 php83-php-pecl-imagick-im6-devel php83-php-imap php83-php-intl php83-php-ldap php83-php-pecl-mailparse php83-php-mbstring php83-php-mcrypt php83-php-pspell php83-php-pecl-redis5 php83-php-snmp php83-php-soap php83-php-tidy php83-php-xml php83-php-xmlrpc php83-php-pecl-zip php83-php-opcache php83-php-sodium libsodium-devel oniguruma5php oniguruma5php-devel php83-php-brotli.x86_64 php83-php-zstd-devel php83-php-process'
...
phpinstall() {
  ...
  sed "s|fastcgi_param  SERVER_NAME        \$server_name;|fastcgi_param  SERVER_NAME        \$http_host;|" /usr/local/nginx/conf/php.conf > /usr/local/nginx/conf/php83-remi.conf
  rsync -ah /bigscoots/wpo/phpfpm/templates/php-version-pool.conf.template /etc/opt/remi/php83/php-fpm.d/www.conf
  sed -i 's|PHPVERSION|php83|' /etc/opt/remi/php83/php-fpm.d/www.conf
