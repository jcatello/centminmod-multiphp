...
packages='php72 php72-php-fpm php72-php-devel php72-php-embedded php72-php-mysqlnd php72-php-bcmath php72-php-enchant php72-php-gd php72-php-pecl-geoip php72-php-gmp php72-php-pecl-igbinary php72-php-pecl-igbinary-devel php72-php-pecl-imagick php72-php-pecl-imagick-devel php72-php-imap php72-php-intl php72-php-pecl-json-post php72-php-ldap php72-php-pecl-mailparse php72-php-mbstring php72-php-mcrypt php72- php72-d php72- php72- php72-php-pspell php72-php-pecl-redis5 php72-php-snmp php72-php-soap php72-php-tidy php72-php-xml php72-php-xmlrpc php72-php-pecl-zip php72-php-opcache'
...
phpinstall() {
  ...
  sed "s|fastcgi_param  SERVER_NAME        \$server_name;|fastcgi_param  SERVER_NAME        \$http_host;|" /usr/local/nginx/conf/php.conf > /usr/local/nginx/conf/php72-remi.conf
